...
//    Point[] points = new Point[n * 2];
    ...
    while (iter.hasNext()) {
      ...
      if (point.left) {
        ...
        if (avlTree.search(point.line).left.element != null &&doIntersect(point.line.left, point.line.right, ((Line) avlTree.search(point.line).left.element).left, ((Line) avlTree.search(point.line).left.element).right)) {
          intersection = true;
          break;
        }
        if (avlTree.search(point.line).right.element != null && doIntersect(point.line.left, point.line.right, ((Line) avlTree.search(point.line).right.element).left, ((Line) avlTree.search(point.line).right.element).right)) {
          intersection = true;
          break;
        }
      } else {
        if (avlTree.search(point.line).left.element != null && avlTree.search(point.line).right.element != null &&doIntersect(((Line) avlTree.search(point.line).left.element).left, ((Line) avlTree.search(point.line).left.element).right, ((Line) avlTree.search(point.line).right.element).left, ((Line) avlTree.search(point.line).right.element).right)) {
          intersection = true;
          break;
        }
